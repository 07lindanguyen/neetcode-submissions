...
class BrowserHistory:
    ...
    def visit(self, url: str) -> None:
        ...
        newPage = HistoryButtons(url, self.currPage)
        self.currPage.next = newPage
        # Update what the current page is
        self.currPage = newPage

    def back(self, steps: int) -> str:
        # Move back in history; stops stepping when it reaches head
    ...
    def forward(self, steps: int) -> str:
        # Move forward in history; stops stepping when it reaches tail
